...
public class Main extends Application { 
	...
	private static AnchorPane mainLayout;
	 ...
	 /**
	  * Uvodna scena kde vyberame pocty instancii
	  * @throws IOException
	  */
	...
	/**
	 * Scena ak je prihlaseny dispecer
	 * @throws IOException
	 */
	...
	/**
	 * Scena ak je prihlaseny KontrolnyDispecer
	 * @throws IOException
	 */
	public static void scenaPrihlasenyKontrolnyDispecer() throws IOException
	{
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(Main.class.getResource("/application/PrihlasenyKontrolnyDispecer.fxml"));
		mainLayout = loader.load();
		Scene scena = new Scene(mainLayout);
		stage.setScene(scena);
		stage.show();
